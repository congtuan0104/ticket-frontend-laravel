        ...
        <div class="w-[70%] pt-5">
            ...
            <div class="my-5">
                ...
                <div class="bg-white rounded-lg p-4 flex gap-5">
                    ...
                    <div class="flex-1">
                        <p class="text-lg">Công ty 123</p>

                        <p class="text-justify mt-3">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent scelerisque semper eros
                            sit amet aliquam. Nullam placerat vitae nulla sed pellentesque. Vestibulum at eleifend nisl.
                            Morbi gravida ante in pellentesque fermentum. Curabitur vehicula eleifend orci, quis
                            pharetra odio volutpat non. Aliquam id augue ante. Donec molestie venenatis ipsum id
                            sodales. Quisque aliquet mi et suscipit facilisis.
                        </p>
            ...
            <div class="my-5">
                ...
                <div class="bg-white rounded-lg p-4 flex gap-5 text-justify">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent scelerisque semper eros sit amet
                    aliquam. Nullam placerat vitae nulla sed pellentesque. Vestibulum at eleifend nisl. Morbi gravida
                    ante in pellentesque fermentum. Curabitur vehicula eleifend orci, quis pharetra odio volutpat non.
                    Aliquam id augue ante. Donec molestie venenatis ipsum id sodales. Quisque aliquet mi et suscipit
                    facilisis. Curabitur suscipit dui quis ante consectetur blandit. Vivamus arcu mi, porta sed arcu
                    non, blandit viverra risus. Nullam ut condimentum eros, nec accumsan odio. Duis a semper felis.
                    Donec accumsan congue dui, et dignissim ipsum elementum a. Proin condimentum mollis dolor sit amet
                    elementum. Donec ac imperdiet dui, ac ornare ante.
                    Nullam fermentum dolor a sapien feugiat, in consectetur nisl sagittis. Nulla maximus magna et enim
                    faucibus auctor. Duis sed eros vehicula, lacinia massa nec, aliquam enim. Donec semper libero
                    porttitor sem finibus pretium. Nam vitae velit tempor, tincidunt est eget, sollicitudin turpis.
                    Vestibulum enim sem, pellentesque quis posuere vel, placerat id mi. Quisque quis augue consectetur,
                    mollis lectus et, fringilla tortor.
                </div>
            </div>
                ...
                <div class="flex flex-col bg-white rounded-lg p-4 ">
                    <div class="flex justify-between border-b border-gray-300 py-3">
                        <div class="flex flex-col gap-4">
                            <p class="uppercase text-lg">Vé thường</p>
                            <p>Thông tin vé thường</p>
                        </div>
                        <div class="flex flex-col gap-2 items-end">
                            <p class="text-green-700 text-md mr-2">100.000đ</p>
            ...
            <div class="flex flex-col mt-3 flex-1 gap-5">
                <div class="flex gap-3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="font-bold text-[16px]">01/06/2024</p>
                    </div>
                </div>
                <div class="flex gap-3">
                    <div class="bg-blue-50 rounded-full flex justify-center items-center size-10">
                    ...
                    <div class="flex flex-col flex-1">
                        ...
                        <p class="font-bold text-[16px]">Đường 29, khu công nghệ cao, quận 9, TP.Hồ Chí Minh</p>
                    </div>
                </div>
                <div class="flex gap-3">
                    <div class="bg-blue-50 rounded-full flex justify-center items-center size-10">
                    ...
                    <div class="flex flex-col flex-1">
                        ...
                        <p class="font-bold text-[16px]">Ca nhạc</p>
                    </div>
                </div>
            </div>
